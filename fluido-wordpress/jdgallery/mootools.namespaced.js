...
//new Moo.Class({
	...
	//initialize:function(B,A){
		//this.element=this.subject=Moo.$(B);
	//	this.parent(A)
	//},
	set:function(B,A){
...
Moo.Element.Properties.tween={
	set:function(A){
		var B=this.retrieve("tween");
		if(B){B.cancel()}
		return this.eliminate("tween").store("tween:options",Moo.$extend({link:"cancel"},A))
	},
	get:function(A){
		if(A||!this.retrieve("tween")){
			...
			this.store("tween",new Moo.Fx.Tween(this,this.retrieve("tween:options")))
		}
